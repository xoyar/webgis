...
<head>
  ...
  .modal-footer {
    ...
    <!-- 引入百度地图-->
    <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=ouhQVknRBuWmNBPw9vqMFNcScOQXMMuh"></script>
</head>
...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 1px;">
    <div class="navbar-header">
        <%--<img src="${pageContext.request.contextPath}/resources/img/children.png" height="48" width="48"/>--%>
...
<script >
    ...
    map.centerAndZoom(new BMap.Point(108.404, 34.915), 9);  // 初始化地图,设置中心点坐标和地图级别
    //添加地图类型控件
